...
- 사다리 타기와 비슷한 운으로 승부가 갈리는 친구와 함께 간단하게 즐길 수 있는 게임
...
1. 피셔-에이츠 셔플 알고리즘
>카드를 완전 무작위로 섞어 게임 승패 밸런스를 구현

2. 점수판 및 목표 점수 설정
>플레이어가 설정한 목표 점수에 도달하면 자동으로 게임 종료

3. 동적 점수판 업데이트
>턴이 끝날 때마다 점수를 실시간으로 업데이트

4. 로컬 스토리지 이용
>게임 승자 정보를 로컬 스토리지에 저장하고 랭킹판에 표시
